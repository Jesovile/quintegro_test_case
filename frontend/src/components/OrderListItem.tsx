...
const OrderListItem: React.FC<OrderListItemProps> = ({
  ...
  const handleIncrement = () => handleAmountChange(currentAmount + 1)
  const handleDecrement = () => handleAmountChange(currentAmount - 1)
      ...
      <CardContent className="p-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col items-end gap-3">
            ...
            {readOnly ? (
              <p className="text-sm text-gray-600">Qty: {currentAmount}</p>
            ) : (
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="h-9 w-9 text-red-600 hover:bg-red-500 hover:text-white"
                >
